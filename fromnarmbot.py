...
bot = telebot.TeleBot("1663445127:AAGkw8BdQA7VRDz-RugB_mJ8qmrzSYkxD_Q")
users = []    
...
def handle_all_message(message):
    ...
    try:
        ...
        bot.reply_to(message, "Daxil etdiyiniz filmə oxşar film tapa bilmədik, zəhmət olmasa filmin adını düzgün daxil etdiyinizdən əmin olun :)") 
